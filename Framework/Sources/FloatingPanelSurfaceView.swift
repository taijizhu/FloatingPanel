...
<<<<<<< HEAD
@objc class FloatingPanelSurfaceContentView: UIView {}

=======
>>>>>>> upstream/master
/// A view that presents a surface interface in a floating panel.
@objc public class FloatingPanelSurfaceView: UIView {
...
<<<<<<< HEAD
    ...
    @objc public var grabberHandle: GrabberHandleView!

    /// The height of the grabber bar area
    @objc public static var topGrabberBarHeight: CGFloat {
...
<<<<<<< HEAD
    @objc public var cornerRadius: CGFloat = 0.0 { didSet { setNeedsLayout() } }
=======
...
>>>>>>> upstream/master
    ...
    @objc public var shadowHidden: Bool = false  { didSet { setNeedsLayout() } }

    /// The color of the surface shadow.
    @objc public var shadowColor: UIColor = .black  { didSet { setNeedsLayout() } }

    /// The offset (in points) of the surface shadow.
    @objc public var shadowOffset: CGSize = CGSize(width: 0.0, height: 1.0)  { didSet { setNeedsLayout() } }

    /// The opacity of the surface shadow.
    @objc public var shadowOpacity: Float = 0.2 { didSet { setNeedsLayout() } }

    /// The blur radius (in points) used to render the surface shadow.
    @objc public var shadowRadius: CGFloat = 3  { didSet { setNeedsLayout() } }

    /// The width of the surface border.
    @objc public var borderColor: UIColor?  { didSet { setNeedsLayout() } }

    /// The color of the surface border.
    @objc public var borderWidth: CGFloat = 0.0  { didSet { setNeedsLayout() } }
...
<<<<<<< HEAD
    @objc func set(bottomOverflow: CGFloat) {
...
<<<<<<< HEAD
    @objc func add(childView: UIView) {
